...
![Sentinel-1 + Sentinel-2 fusion crop classification map](assets/classification_map_4.png)
...
![Landsat-8 crop classification map](assets/classification_map_5.png)
...
│   └── classification_map_2-5.png # Per-sensor best-performing classification outputs
└── docs/
